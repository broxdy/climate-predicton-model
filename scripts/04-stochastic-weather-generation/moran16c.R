...
dir_name = "predict_v16c_predict rainyday"
...
#random.rain.prob1 = array(v.normal.model.gen(v.predict.gen.seed[,,1]), c(31,station.n))
...
for(uni in 1:unique.n){
	...
	v.normal.gen = array(NA, c(weight.n,unique.rainy.day.n[uni],weather.gen.predict.realiz.n)) # set the matrix
