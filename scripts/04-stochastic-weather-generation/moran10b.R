...
legend(x = "top",  bty = "n",  lty = c(1,1,1),  lwd = c(2,2,2), col = c("red","blue","green"),  legend = c("Observed Moran's I","Simulated Moran's I (from mean rain)","Simulated Moran's I (daily average)"))
dev.off()
...
setwd(dir0)
plot(total.daily.ma.coef, type = "l", lwd = 2 ,col = "red", lty = 1)
par(new = TRUE)
plot(total.daily.avg.moran.i, type = "l", yaxt = "n" , lwd = 2 , col = "blue", lty = 1)
axis(4)
