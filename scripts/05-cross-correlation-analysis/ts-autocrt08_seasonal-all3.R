...
dir_name="ts-autocrt08_seasonal-all3"
...
total.season = 3 # number of season
...
if(run.thissub){
setwd(dir1)
sink(paste("seasonal_corrl-",substr(datafile[loop],1,nchar(datafile[loop])-4),".csv"))
setwd(dir0)
...
if(run.thissub){
setwd(dir1)
sink(paste("seasonal_r2-",substr(datafile[loop],1,nchar(datafile[loop])-4),".csv"))
setwd(dir0)
