...
# output directory
dir_name= paste("ts-cross-cor-GCMreal_monthlyOBSs-V3_",total.season,"season")
...
if(run.thissub){
setwd(dir1)
sink(paste("Corr Input for downscaling_",substr(fobs[loop],1,nchar(fobs[loop])-4),".csv"))
setwd(dir0)
