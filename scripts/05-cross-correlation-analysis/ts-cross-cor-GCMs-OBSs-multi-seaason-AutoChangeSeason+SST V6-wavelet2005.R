...
findex = "ocean index 1971-2009.csv"
...
# output directory
prefix.dir = "cross_cor-GCM_OBSs-V7+defaultSSTs+Wavelet2005"
#prefix.dir = "cross_cor-GCM_OBSs-V7+defaultSSTs+Wavelet"
...
startmonth.obs=1
startmonth0.obs=1
endyear.obs=2005 # if 12/2000 have to set to endyear= 2000
