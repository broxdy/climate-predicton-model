...
# output directory
dir_name="ts-cross-cor-GCMsv4monthly-OBSs-2season"
...
dataindex <- read.table("Monthly_GCMs1971-1999(2000)v4m.csv", stringsAsFactors=FALSE,header=TRUE, sep=",",dec=".",na.strings="-")
