...
config.nprd.f = "config_blank+SSTs 1 season.csv"
...
#order.seasonal.file = c("CORRL_all-zero+optimal-lagSSTs_2 season.csv","CORRL_all-zero+optimal-lagSSTs_3 season.csv","CORRL_all-zero+optimal-lagSSTs_4 season.csv") # only optimal-lagSSTs (+ zero value table)
order.seasonal.file = c("CORRL_all-zero+defaultSSTs_2 season.csv","CORRL_all-zero+defaultSSTs_3 season.csv","CORRL_all-zero+defaultSSTs_4 season.csv") # only defaultSSTs (+ zero value table)
...
#v.prefix = "V9f_optimal-lagSSTs_Cal1971-1999_Vrf1986-1999_Sim1971-1999-2099_3season_" # change obsdata file name & verifyfactor to change verificaiton period
#v.prefix = "V9f_optimal-lagSSTs_Cal1971-1999_Vrf2000-2006_Sim1971-1999-2099_3season_" # change obsdata file name & verifyfactor to change verificaiton period
v.prefix = "V9f_defaultSSTs_Cal1971-1999_Vrf1986-1999_Sim1971-1999-2099__all 1 season__" # change obsdata file name & verifyfactor to change verificaiton period
