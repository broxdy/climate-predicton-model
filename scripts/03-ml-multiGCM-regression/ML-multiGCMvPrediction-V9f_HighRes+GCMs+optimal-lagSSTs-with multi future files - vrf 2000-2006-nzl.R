...
optimal.lag = TRUE # change config order seasonal file (CORRL) to default/optimal-lag
...
order.seasonal.file = c("CORRL_onthly-v5+high res+optimal-lagSSTs_2 season-nzl.csv","CORRL_onthly-v5+high res+optimal-lagSSTs_3 season-nzl.csv","CORRL_onthly-v5+high res+optimal-lagSSTs_4 season-nzl.csv") # optimal-lag (no-zero-lag) SSTs
...
#v.prefix = "V9f_GCMs+high-res+optimal-lagSSTs_Cal1971-1999_Vrf1986-1999_Sim1971-1999-2099__" # change obsdata file name & verifyfactor to change verificaiton period
v.prefix = "V9f_GCMs+high-res+optimal-lagSSTs_Cal1971-1999_Vrf2000-2006_Sim1971-1999-2099-nzl__" # change obsdata file name & verifyfactor to change verificaiton period
#v.prefix = "V9f_GCMs+high-res+optimal-lagSSTs_Cal1971-1999_Vrf1986-1999_Sim1971-1999-2099__all 1 season__" # change obsdata file name & verifyfactor to change verificaiton period
...
#setwd(dir2)
setwd(dir1)
write.csv(all.prd.calvrf,file=paste("Cal+Vrf",sub(".csv","",indexf.future),".csv"), row.names=FALSE)
setwd(dir0)
setwd(dir3)
