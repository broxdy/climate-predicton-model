...
cat("Read file list\n")
sheetf = "20c3m-mo-ECHAM5.csv"
sheet.list <- read.table(sheetf, stringsAsFactors=FALSE,header=TRUE, sep=",",dec=".",na.strings = "-")
# Output name
out.file = "output"
## specify output folder here
dir_name ="20c3m-mo-ECHAM5"

L=file.exists(dir_name)  
if(!L) dir.create(dir_name)
dir0=dirname(file.path("D:","CMIP3","20c3m","ECHAM5","dummy"))
dir1=dirname(file.path("D:","CMIP3","20c3m","ECHAM5",paste(dir_name),"dummy"))
