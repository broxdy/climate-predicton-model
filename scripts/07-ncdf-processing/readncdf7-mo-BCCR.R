...
sheetf = "20c3m-mo-BCCR.csv"
sheet.list <- read.table(sheetf, stringsAsFactors=FALSE,header=TRUE, sep=",",dec=".",na.strings = "-")
# Output name
out.file = "output"
## specify output folder here
dir_name ="20c3m-mo-BCCR"

L=file.exists(dir_name)  
if(!L) dir.create(dir_name)
dir0=dirname(file.path("D:","CMIP3","20c3m","BCCR-BCM2","dummy"))
dir1=dirname(file.path("D:","CMIP3","20c3m","BCCR-BCM2",paste(dir_name),"dummy"))
