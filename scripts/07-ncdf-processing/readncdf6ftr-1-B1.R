...
sheetf = "future file list B1v2a.csv"
...
dir0=dirname(file.path("D:","CMIP3","Future Scenario","B1","dummy"))
dir1=dirname(file.path("D:","CMIP3","Future Scenario","B1",paste(dir_name),"dummy"))
