...
# 1b) Input file
dataf = "RainRayong-1971rv5_366days.csv"
...
start0=19171 #year start in table file
startyear=1971 #year to analysis begins
endyear=2005
endday=90 # 0 means end of endyear (endyear  1, endyear=2006, endday=0 ** end date = 31/12/2006)
...
dirn = "NAv6RainRayong-1971rv4_366days-without_intercept8-4-24-24-4-1-byr2 v2 with PDF"
#dirn = "NAv5-3Rayong-tmp1971-with_intercept7-4-7-7-4-1-byr2-test"
output.dec = 1
...
pdtcol = 1
first.min.predictor = 20 # minimum number of predictors used in prediction at first loop
last.min.predictor = 4 # minimum number of predictors used in prediction at last loop
first.max.predictor = 23 # max number of predictors selected at first time
maxpredictor = 23 # entirely maximum included number of predictors in extra prediction (extprd)
