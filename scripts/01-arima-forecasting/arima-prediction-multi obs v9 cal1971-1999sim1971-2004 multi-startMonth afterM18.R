...
dir_name="v8-arima-cal1971-1999_sim2000-2004 lim p at 2 multi-startMonth AfterMonth18"
...
endyear.c=2000
endmonth.c=6 # endmonth.c = 9 endyear.c = 1999, so Date end = 09/2000 // endmonth.c = 0 endyear.c = 1999, so Date end = 12/1999
### Verification
