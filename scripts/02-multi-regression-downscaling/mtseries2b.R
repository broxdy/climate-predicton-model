...
par(ps =12)
	...
	cellcol[acfmax<0]<-color.scale(acfmax[acfmax<0],c(0,0.6,1),c(0,0),c(1,0.2,0))
	cellcol[acfmax>=0]<-color.scale(acfmax[acfmax>=0],c(1,0.6,0),c(0,0),c(0,0.2,1))
...
par(ps =12)
	...
	cellcol[acfmax<0]<-color.scale(acfmax[acfmax<0],c(0,0.6,1),c(0,0),c(1,0.2,0))
	cellcol[acfmax>=0]<-color.scale(acfmax[acfmax>=0],c(1,0.6,0),c(0,0),c(0,0.2,1))
#	cellcol[acfmax>=0]<-color.scale(acfmax[acfmax>=0],c(0.8,0,0),c(0,1),0)
color2D.matplot(acfmax,cellcolors=cellcol,nslices=20,axes=FALSE,xlab="climate parameters",ylab="",
