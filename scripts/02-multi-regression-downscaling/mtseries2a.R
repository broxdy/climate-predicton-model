...
#*********************** Matrix PDF ***********************************
#*********************** Print matrix for all corl ***********************************
setwd(dir1)
pdf(paste("ColorMatrix_CGCM-DAI.pdf"), width= 15, height = 15)
par(ps =12)
	cellcol<-matrix(rep("#000000",nparmat*nparmat),nrow=nparmat)
	cellcol[acfmat<0]<-color.scale(acfmat[acfmat<0],c(0,1),c(1,0),0)
	cellcol[acfmat>=0]<-color.scale(acfmat[acfmat>=0],c(1,0),c(0,1),0)
color2D.matplot(acfmat,cellcolors=cellcol,nslices=20,axes=FALSE,xlab="climate parameters",ylab="",
show.legend=FALSE, show.values=TRUE,main="Maximum Cross-Correlation both (+/-) lagtime of CGCM3-DAI paramters")
	legval<-seq(min(acfmat),max(acfmat),length.out=20)
	legcol<-rep("#000000",20)
	legcol[legval<0]<-color.scale(legval[legval<0],c(0,1),c(1,0),0)
	legcol[legval>=0]<-color.scale(legval[legval>=0],c(1,0),c(0,1),0)
	color.legend(0,-1,3.5,-0.8,round(c(min(acfmat),0,max(acfmat)),1),rect.col=legcol)
...
par(ps =12)
	cellcol<-matrix(rep("#000000",nparmat*nparmat),nrow=nparmat)
	cellcol[lagmat<0]<-color.scale(lagmat[lagmat<0],c(1,0),c(0,1),0)
	cellcol[lagmat>=0]<-color.scale(lagmat[lagmat>=0],c(0,0),c(1,0),c(0.2,.8))
color2D.matplot(lagmat,cellcolors=cellcol,axes=FALSE,xlab="climate parameters",ylab="",
show.legend=FALSE, show.values=TRUE,main="Lag time (+/-) at maximum correlation of CGCM3-DAI parameters")
	legval<-seq(min(lagmat),max(lagmat),length.out=(max(lagmat)-min(lagmat)))
	legcol<-rep("#000000",20)
	legcol[legval<0]<-color.scale(legval[legval<0],c(1,0),c(0,1),0)
	legcol[legval>=0]<-color.scale(legval[legval>=0],c(0,0),c(1,0),c(0.2,0.8))
	color.legend(0,-1,3.5,-0.8,round(c(min(lagmat),0,max(lagmat)),1),rect.col=legcol)
...
par(ps =12)
	cellcol<-matrix(rep("#000000",nparmat*nparmat),nrow=nparmat)
	cellcol[acfmax<0]<-color.scale(acfmax[acfmax<0],c(0,1),c(1,0),0)
	cellcol[acfmax>=0]<-color.scale(acfmax[acfmax>=0],c(1,0),c(0,1),0)
color2D.matplot(acfmax,cellcolors=cellcol,nslices=20,axes=FALSE,xlab="climate parameters",ylab="",
show.legend=FALSE, show.values=TRUE,main="Maximum Cross-Correlation of CGCM3-DAI paramters")
	legval<-seq(min(acfmax),max(acfmax),length.out=20)
	legcol<-rep("#000000",20)
	legcol[legval<0]<-color.scale(legval[legval<0],c(0,1),c(1,0),0)
	legcol[legval>=0]<-color.scale(legval[legval>=0],c(1,0),c(0,1),0)
...
color2D.matplot(lagmax,cellcolors=cellcol,axes=FALSE,xlab="climate parameters",ylab="",
show.legend=FALSE, show.values=TRUE,main="Lag time at maximum correlation of CGCM3-DAI parameters")
	legval<-seq(min(lagmax),max(lagmax),length.out=(max(lagmax)-min(lagmax)))
	legcol<-rep("#000000",20)
	legcol[legval<0]<-color.scale(legval[legval<0],c(1,0),c(0,1),0)
	legcol[legval>=0]<-color.scale(legval[legval>=0],c(0,0),c(1,0),c(0.2,0.8))
	color.legend(0,-1,3.5,-0.8,round(c(-14,0,14),1),rect.col=legcol)
...
par(ps =12)
	...
	cellcol[acfmat>=0]<-color.scale(acfmat[acfmat>=0],c(1,0),c(0,1),0)
color2D.matplot(acfmat,cellcolors=cellcol,nslices=20,axes=FALSE,xlab="climate parameters",ylab="",
show.legend=FALSE, show.values=TRUE,main="Maximum Cross-Correlation both (+/-) lagtime of CGCM3-2D paramters")
	legval<-seq(min(acfmat),max(acfmat),length.out=20)
	legcol<-rep("#000000",20)
	legcol[legval<0]<-color.scale(legval[legval<0],c(0,1),c(1,0),0)
	legcol[legval>=0]<-color.scale(legval[legval>=0],c(1,0),c(0,1),0)
...
par(ps =12)
	...
	cellcol[acfmax>=0]<-color.scale(acfmax[acfmax>=0],c(1,0),c(0,1),0)
color2D.matplot(acfmax,cellcolors=cellcol,nslices=20,axes=FALSE,xlab="climate parameters",ylab="",
show.legend=FALSE, show.values=TRUE,main="Maximum Cross-Correlation of CGCM3-2D paramters")
	legval<-seq(min(acfmax),max(acfmax),length.out=20)
	legcol<-rep("#000000",20)
	legcol[legval<0]<-color.scale(legval[legval<0],c(0,1),c(1,0),0)
	legcol[legval>=0]<-color.scale(legval[legval>=0],c(1,0),c(0,1),0)
