...
dir_name="reg-allobsV12monthly cal1971-1985 vrf1986-2000 sim1971-2000-future+SST"
...
gcm.f.list = c("ECHO-G monthly 2000-2100_A1B+SST.csv",
"ECHO-G monthly 2000-2100_A2+SST.csv",
"ECHO-G monthly 2000-2100_B1+SST.csv")
future.date.col = c(1:2)

obs.f = "monthly-obs_filled1971-2006(4)_v2.csv"
gcm.f = "ECHO-G monthly 1971-1999 selection+SST.csv"
